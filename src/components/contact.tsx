...
export default function Contact() {
    return (<section id="contact" className="max-w-4xl mx-auto py-24 md:py-32  space-y-8">
...
<div className="container max-w-3xl mx-auto">
          <div className="text-center space-y-8">
            ...
            <div className="flex flex-col items-center justify-center p-8 border rounded-lg shadow-sm bg-white mt-8">
              ...
              <a href="mailto:nianguye2002@gmail.com" className="text-primary hover:underline text-lg font-medium">
